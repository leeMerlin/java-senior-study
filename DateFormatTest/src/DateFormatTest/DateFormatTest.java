...
public class DateFormatTest {
    public static void main(String[] args) {
        ...
        DateFormat df3 = new SimpleDateFormat("yyyy年MM月dd天 hh时mm分ss秒 EE", Locale.CHINA);
        ...
        System.out.println("按照Java的默认日期格式：" + df1.format(date));
        System.out.println("按照指定格式 yyyy-MM-dd hh:mm:ss EE,系统默认区域：" + df2.format(date));
        System.out.println("按照指定格式 yyyy年MM月dd天 hh时mm分ss秒 EE, 区域为中国 ：" + df3.format(date));
